...
# 25.12.11 : each 11 hospital has its own independent mu omega
...
person_error <- c(3,2,2,3,4,2,5,3,3,6,3)
person_total <- c(19,32,12,16,41,24,48,20,18,58,30)

#hos_death <- c(25,24,23,25,42,24,53,26,25,58,31)
#hos_total <- c(87,323,122,164,405,239,482,195,177,581,301)
n <- length(person_total)



# pack as a list for JAGS
data <-  list(y=person_error, n=person_total,N=n)
...
#model comparison
dic_M11NH<- dic.samples(model, n.iter=10000, progress.bar="none")
dic_M11NH
