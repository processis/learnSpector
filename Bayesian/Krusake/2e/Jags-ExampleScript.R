...
source("/media/user/娱乐/learnSpector/Bayesian/Krusake/2e/DBDA2E-utilities.R") # Must be in R's current working directory.
require(rjags)               # Must have previously installed package rjags.

fileNameRoot="Jags-ExampleScript" # For output file names.

# Load the data:
myData = read.csv("/media/user/娱乐/learnSpector/Bayesian/Krusake/2e/z15N50.csv") # Read data file; must be in curr. work. dir.
