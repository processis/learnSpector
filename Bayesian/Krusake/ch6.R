...
dat         <- read.csv("/media/user/娱乐/learnSpector/Bayesian/Krusake/BSMdata/Erickson.csv")
...
load("/media/user/娱乐/learnSpector/Bayesian/Krusake/BSMdata/BostonMarathon2016.Rdata")
